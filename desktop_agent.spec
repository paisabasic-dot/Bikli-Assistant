...
"""
PyInstaller spec for the BIKLI Desktop Control Agent.

Produces a self-contained onedir bundle (bikli-agent/bikli-agent.exe) with an
...
hiddenimports += [
    ...
    "desktop_agent.tools_control",
    "desktop_agent.tools_cursor",
...
# Office document libraries (createWordFile / createExcelFile / createPowerPointFile).
hiddenimports += collect_submodules("docx")
hiddenimports += collect_submodules("openpyxl")
hiddenimports += collect_submodules("pptx")
hiddenimports += ["lxml", "lxml.etree", "lxml._elementpath", "xlsxwriter"]
